...
class TestFlexBook1Assert(unittest.TestCase):
    def setUp(self):
        ...
        signin_modal.signInAction("testmail.dailyjobs+teacher@gmail.com", "Shopana@123")
        time.sleep(4)
    ...
    def test_user_name(self):
        ...
        find_user_name = driver.find_element_by_xpath("//span[@class='sc-csuQGl hrnDev']")
    ...
    def test_flexbook_page(self):
        ...
        explore.selectItem(FlexbookPageLocators.FB_EXPLORE_MENU, FlexbookPageLocators.FB_FLEXBOOK_OPTION)
    ...
    def test_flexbook_selectOptions(self, lang, sub, grade, title):
        ...
        self.driver.get("https://www.ck12.org/fbbrowse/?_ga=2.236491137.14732433.1612994297-1650535856.1612577864")
    ...
    def test_fb_select(self):
        ...
        self.driver.get("https://www.ck12.org/fbbrowse/list/?Subject=Algebra&Language=English&Grade=Middle%20School")
        book = FbBrowseListPage(self.driver)
        assert book.checkMatch()
        
    def test_customizeBookTitle(self):
        #Change the tiltle of the flexbook
        self.driver.get("https://www.ck12.org/book/CK-12-Middle-School-Math-Concepts-Grade-8/")    
    ...
    def test_customizeChapterTitle(self):
        self.driver.get("https://www.ck12.org/editor/book/CK-12-Algebra-Basic/r32/")
        custom = CustomizePage(self.driver)
    ...
    def test_move_Chap(self):
        self.driver.get("https://www.ck12.org/editor/book/CK-12-Algebra-Basic/r32/")
        time.sleep(3)
        mv_chap = CustomizePage(self.driver)
        assert mv_chap.moveToChap()      
        
        # #Click on expand toggle of chapter 1
        # chap1_expand_toggle = getElement(FBMathAlgeb8GradeCustomizeLocators.CHAP1_EXPAND_TOGGLE)
        # chap1_expand_toggle.click()
        
        # time.sleep(6)
        # #select edit from the ellipsis
        # ellip = FlexPage(self.driver)
        # ellip.selectItem(FBMathAlgeb8GradeCustomizeLocators.R1_ELLIPSIS_ICON, FBMathAlgeb8GradeCustomizeLocators.R1_DD_EDIT)
        
        # #Change the title of the read
        # read1_title_clear = getElement(FBMathAlgeb8GradeCustomizeLocators.R1_TITLE_FIELD) 
        # read1_title_clear.clear()
        # read1_title_clear.send_keys("Sho: Analyzing Graphs")
        # time.sleep(3)
        # read1_title_save = getElement(FBMathAlgeb8GradeCustomizeLocators.R1_TITLE_SAVE_BUTTON)
        # read1_title_save.click()

        # time.sleep(10)
        # #assert tiny mce editor
        # tiny_MCE_editor = getElement(FBMathAlgeb8GradeCustomizeLocators.MCE_EDITOR_MENU)
        # assert tiny_MCE_editor != None
